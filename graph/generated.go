...
type ComplexityRoot struct {
	...
	Mutation struct {
		Login func(childComplexity int, email string, passoword string) int
	}
...
type MutationResolver interface {
	Login(ctx context.Context, email string, passoword string) (*model.AuthPayload, error)
}
...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Mutation.login":
		...
		return e.complexity.Mutation.Login(childComplexity, args["email"].(string), args["passoword"].(string)), true
...
func (ec *executionContext) field_Mutation_login_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	...
	args["email"] = arg0
	arg1, err := ec.field_Mutation_login_argsPassoword(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
	args["passoword"] = arg1
...
func (ec *executionContext) field_Mutation_login_argsPassoword(
	ctx context.Context,
	rawArgs map[string]any,
) (string, error) {
	ctx = graphql.WithPathContext(ctx, graphql.NewPathWithField("passoword"))
	if tmp, ok := rawArgs["passoword"]; ok {
		return ec.unmarshalNString2string(ctx, tmp)
	}
...
func (ec *executionContext) _Mutation_login(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().Login(rctx, fc.Args["email"].(string), fc.Args["passoword"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	fc.Result = res
	return ec.marshalNAuthPayload2ᚖgithubᚗcomᚋlevanter914ᚋloginᚑbackendᚗgitᚋgraphᚋmodelᚐAuthPayload(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNAuthPayload2githubᚗcomᚋlevanter914ᚋloginᚑbackendᚗgitᚋgraphᚋmodelᚐAuthPayload(ctx context.Context, sel ast.SelectionSet, v model.AuthPayload) graphql.Marshaler {
	return ec._AuthPayload(ctx, sel, &v)
}

func (ec *executionContext) marshalNAuthPayload2ᚖgithubᚗcomᚋlevanter914ᚋloginᚑbackendᚗgitᚋgraphᚋmodelᚐAuthPayload(ctx context.Context, sel ast.SelectionSet, v *model.AuthPayload) graphql.Marshaler {
	if v == nil {
